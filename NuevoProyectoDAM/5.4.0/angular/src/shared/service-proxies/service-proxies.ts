...
export class AnuncioServiceProxy {
    ...
    getUsuariosGustaAnuncio(id: number | undefined): Observable<AnuncioGustaAUsuariosDtoListResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUsuariosGustaAnuncio(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUsuariosGustaAnuncio(<any>response_);
                } catch (e) {
                    return <Observable<AnuncioGustaAUsuariosDtoListResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<AnuncioGustaAUsuariosDtoListResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetUsuariosGustaAnuncio(response: HttpResponseBase): Observable<AnuncioGustaAUsuariosDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = AnuncioGustaAUsuariosDtoListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    busquedaAnunciosPorMunicipio(municipio: string | undefined): Observable<AnuncioDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Anuncio/BusquedaAnunciosPorMunicipio?";
        if (municipio === null)
            throw new Error("The parameter 'municipio' cannot be null.");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBusquedaAnunciosPorMunicipio(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBusquedaAnunciosPorMunicipio(<any>response_);
                } catch (e) {
                    return <Observable<AnuncioDtoListResultDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processBusquedaAnunciosPorMunicipio(response: HttpResponseBase): Observable<AnuncioDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * @param ciudad (optional) 
     * @return Success
     */
    busquedaAnunciosPorCiudad(ciudad: string | undefined): Observable<AnuncioDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Anuncio/BusquedaAnunciosPorCiudad?";
        if (ciudad === null)
            throw new Error("The parameter 'ciudad' cannot be null.");
        else if (ciudad !== undefined)
            url_ += "ciudad=" + encodeURIComponent("" + ciudad) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBusquedaAnunciosPorCiudad(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBusquedaAnunciosPorCiudad(<any>response_);
                } catch (e) {
                    return <Observable<AnuncioDtoListResultDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processBusquedaAnunciosPorCiudad(response: HttpResponseBase): Observable<AnuncioDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    busquedaAnunciosPorCategoria(categoria: string | undefined): Observable<AnuncioDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Anuncio/BusquedaAnunciosPorCategoria?";
        if (categoria === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBusquedaAnunciosPorCategoria(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBusquedaAnunciosPorCategoria(<any>response_);
                } catch (e) {
                    return <Observable<AnuncioDtoListResultDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processBusquedaAnunciosPorCategoria(response: HttpResponseBase): Observable<AnuncioDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ChatServiceProxy {
     ...
     * @return Success
     */
    create(body: ChatCreateDto | undefined): Observable<ChatDto> {
    ...
    getUsuariosConLosQueHabla(): Observable<MostrarChatReducidoDtoListResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUsuariosConLosQueHabla(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ChatDtoPagedResultDto> {
...
export class PeticionServiceProxy {
     ...
     * @return Success
     */
    busquedaPeticionesPorMunicipio(municipio: string | undefined): Observable<PeticionDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Peticion/BusquedaPeticionesPorMunicipio?";
        if (municipio === null)
            throw new Error("The parameter 'municipio' cannot be null.");
        else if (municipio !== undefined)
            url_ += "municipio=" + encodeURIComponent("" + municipio) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBusquedaPeticionesPorMunicipio(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBusquedaPeticionesPorMunicipio(<any>response_);
                } catch (e) {
                    return <Observable<PeticionDtoListResultDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processBusquedaPeticionesPorMunicipio(response: HttpResponseBase): Observable<PeticionDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    busquedaPeticionesPorCiudad(ciudad: string | undefined): Observable<PeticionDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Peticion/BusquedaPeticionesPorCiudad?";
        if (ciudad === null)
            throw new Error("The parameter 'ciudad' cannot be null.");
        else if (ciudad !== undefined)
            url_ += "ciudad=" + encodeURIComponent("" + ciudad) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBusquedaPeticionesPorCiudad(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBusquedaPeticionesPorCiudad(<any>response_);
                } catch (e) {
                    return <Observable<PeticionDtoListResultDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processBusquedaPeticionesPorCiudad(response: HttpResponseBase): Observable<PeticionDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    busquedaPeticionesPorCategoria(categoria: string | undefined): Observable<PeticionDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Peticion/BusquedaPeticionesPorCategoria?";
        if (categoria === null)
            throw new Error("The parameter 'categoria' cannot be null.");
        else if (categoria !== undefined)
            url_ += "categoria=" + encodeURIComponent("" + categoria) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBusquedaPeticionesPorCategoria(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBusquedaPeticionesPorCategoria(<any>response_);
                } catch (e) {
                    return <Observable<PeticionDtoListResultDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processBusquedaPeticionesPorCategoria(response: HttpResponseBase): Observable<PeticionDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * @param urgente (optional) 
     * @return Success
     */
    busquedaPeticionesUrgentes(urgente: boolean | undefined): Observable<PeticionDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Peticion/BusquedaPeticionesUrgentes?";
        if (urgente === null)
            throw new Error("The parameter 'urgente' cannot be null.");
        else if (urgente !== undefined)
            url_ += "urgente=" + encodeURIComponent("" + urgente) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBusquedaPeticionesUrgentes(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBusquedaPeticionesUrgentes(<any>response_);
                } catch (e) {
                    return <Observable<PeticionDtoListResultDto>><any>_observableThrow(e);
                }
            } else
...
@Injectable()
export class PublicacionGustadaServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    /**
     * @param idPublicacion (optional) 
     * @return Success
     */
    usuarioLogadoGustaPublicacion(idPublicacion: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/PublicacionGustada/UsuarioLogadoGustaPublicacion?";
        if (idPublicacion === null)
            throw new Error("The parameter 'idPublicacion' cannot be null.");
        else if (idPublicacion !== undefined)
            url_ += "idPublicacion=" + encodeURIComponent("" + idPublicacion) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUsuarioLogadoGustaPublicacion(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUsuarioLogadoGustaPublicacion(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUsuarioLogadoGustaPublicacion(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    usuarioLogadoNOGustaPublicacion(idPublicacion: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/PublicacionGustada/UsuarioLogadoNOGustaPublicacion?";
        if (idPublicacion === null)
            throw new Error("The parameter 'idPublicacion' cannot be null.");
        else if (idPublicacion !== undefined)
            url_ += "idPublicacion=" + encodeURIComponent("" + idPublicacion) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUsuarioLogadoNOGustaPublicacion(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUsuarioLogadoNOGustaPublicacion(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUsuarioLogadoNOGustaPublicacion(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class UsuarioGustadoServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    usuarioLogadoGustaUsuario(idUser: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/UsuarioGustado/UsuarioLogadoGustaUsuario?";
        if (idUser === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUsuarioLogadoGustaUsuario(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUsuarioLogadoGustaUsuario(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUsuarioLogadoGustaUsuario(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    usuarioLogadoNOGustaUsuario(idUser: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/UsuarioGustado/UsuarioLogadoNOGustaUsuario?";
        if (idUser === null)
            throw new Error("The parameter 'idUser' cannot be null.");
        else if (idUser !== undefined)
            url_ += "idUser=" + encodeURIComponent("" + idUser) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUsuarioLogadoNOGustaUsuario(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUsuarioLogadoNOGustaUsuario(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUsuarioLogadoNOGustaUsuario(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class UsuarioLogadoServiceProxy {
     ...
     * @return Success
     */
    saberSiUsuarioActualEsSeguidor(idUser: number | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/UsuarioLogado/SaberSiUsuarioActualEsSeguidor?";
        if (idUser === null)
            throw new Error("The parameter 'idUser' cannot be null.");
        else if (idUser !== undefined)
            url_ += "idUser=" + encodeURIComponent("" + idUser) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSaberSiUsuarioActualEsSeguidor(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSaberSiUsuarioActualEsSeguidor(<any>response_);
                } catch (e) {
                    return <Observable<boolean>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSaberSiUsuarioActualEsSeguidor(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAllUsuarios(): Observable<UserDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/UsuarioLogado/GetAllUsuarios";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAllUsuarios(response: HttpResponseBase): Observable<UserDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
    update(body: UserDto | undefined): Observable<UserDto> {
        let url_ = this.baseUrl + "/api/services/app/UsuarioLogado/Update";
        url_ = url_.replace(/[?&]$/, "");
...
export class PublicacionGustadaDto implements IPublicacionGustadaDto {
    usuario: UserNameDto;
    id: number;

    constructor(data?: IPublicacionGustadaDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PublicacionGustadaDto {
        data = typeof data === 'object' ? data : {};
        let result = new PublicacionGustadaDto();
        result.init(data);
        return result;
    }
...
export class AnuncioGustaAUsuariosDto implements IAnuncioGustaAUsuariosDto {
    ...
    constructor(data?: IAnuncioGustaAUsuariosDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AnuncioGustaAUsuariosDto {
        data = typeof data === 'object' ? data : {};
        let result = new AnuncioGustaAUsuariosDto();
        result.init(data);
        return result;
    }
    ...
    clone(): AnuncioGustaAUsuariosDto {
        const json = this.toJSON();
        let result = new AnuncioGustaAUsuariosDto();
        result.init(json);
        return result;
...
export interface IAnuncioGustaAUsuariosDto {
    usuariosGustaAnuncio: PublicacionGustadaDto[] | undefined;
    numUsuarios: number;
    id: number;
}

export class AnuncioGustaAUsuariosDtoListResultDto implements IAnuncioGustaAUsuariosDtoListResultDto {
    items: AnuncioGustaAUsuariosDto[] | undefined;

    constructor(data?: IAnuncioGustaAUsuariosDtoListResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(AnuncioGustaAUsuariosDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): AnuncioGustaAUsuariosDtoListResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new AnuncioGustaAUsuariosDtoListResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): AnuncioGustaAUsuariosDtoListResultDto {
        const json = this.toJSON();
        let result = new AnuncioGustaAUsuariosDtoListResultDto();
        result.init(json);
        return result;
...
export interface IAnuncioGustaAUsuariosDtoListResultDto {
    items: AnuncioGustaAUsuariosDto[] | undefined;
}
...
export class ChatCreateDto implements IChatCreateDto {
    ...
    static fromJS(data: any): ChatCreateDto {
        data = typeof data === 'object' ? data : {};
        let result = new ChatCreateDto();
        result.init(data);
        return result;
    }
...
export class PeticionDto implements IPeticionDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.publicacionCiudad = _data["publicacionCiudad"];
            this.publicacionId = _data["publicacionId"];
            if (Array.isArray(_data["usuariosGustaPeticion"])) {
                this.usuariosGustaPeticion = [] as any;
    ...
    toJSON(data?: any) {
        ...
        data["publicacionCiudad"] = this.publicacionCiudad;
        data["publicacionId"] = this.publicacionId;
        if (Array.isArray(this.usuariosGustaPeticion)) {
            data["usuariosGustaPeticion"] = [];
