...
namespace NuevoProyectoDAM.Migrations
{
    ...
    partial class NuevoProyectoDAMDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAM.Chats.Chat", b =>
                {
                    ...
                    b.Property<long>("UsuarioOrigenId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DAM.UsuariosGustados.UsuarioGustado", b =>
                {
                    ...
                    b.Property<long>("UsuarioSeguidoId")
                        .HasColumnType("bigint");

                    b.Property<long>("UsuarioSeguidorId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("NuevoProyectoDAM.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("NuevoProyectoDAM.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("DAM.Chats.Chat", b =>
                {
                    b.HasOne("NuevoProyectoDAM.Authorization.Users.User", "UsuarioDestino")
                        .WithMany("ChatsUsuarioDestino")
                        .HasForeignKey("UsuarioDestinoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NuevoProyectoDAM.Authorization.Users.User", "UsuarioOrigen")
            ...
            modelBuilder.Entity("DAM.Publicaciones.Publicacion", b =>
                {
                    b.HasOne("NuevoProyectoDAM.Authorization.Users.User", "Usuario")
            ...
            modelBuilder.Entity("DAM.UsuariosGustados.UsuarioGustado", b =>
                {
                    b.HasOne("NuevoProyectoDAM.Authorization.Users.User", "UsuarioSeguido")
                        .WithMany("UsuariosSeguidos")
                        .HasForeignKey("UsuarioSeguidoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NuevoProyectoDAM.Authorization.Users.User", "UsuarioSeguidor")
