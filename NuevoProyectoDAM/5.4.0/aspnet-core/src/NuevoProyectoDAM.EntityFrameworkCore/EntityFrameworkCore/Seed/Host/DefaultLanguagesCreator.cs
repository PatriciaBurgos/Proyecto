...
namespace NuevoProyectoDAM.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = NuevoProyectoDAMConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(NuevoProyectoDAMDbContext context)
        {
            _context = context;
        }
